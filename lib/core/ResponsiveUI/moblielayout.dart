...
import 'package:profile/core/ResponsiveUI/mobilebody.dart';
...
class Moblielayout extends StatefulWidget {
  const Moblielayout({super.key});

  @override
  State<Moblielayout> createState() => _MoblielayoutState();
}

class _MoblielayoutState extends State<Moblielayout> {
